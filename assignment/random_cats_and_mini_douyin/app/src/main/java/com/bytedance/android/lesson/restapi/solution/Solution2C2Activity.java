...
public class Solution2C2Activity extends AppCompatActivity {
    ...
    private void postVideo() {
        ...
        String student_id = "1120161939";
        String username = "Chang Hongzhi";
    ...
    public void fetchFeed(View view) {
        ...
        Retrofit feedRetrofit = RetrofitManager.get("http://test.androidcamp.bytedance.com/");
        feedRetrofit.create(IMiniDouyinService.class).fetchFeed().enqueue(new Callback<FeedResponse>(){
            @Override
